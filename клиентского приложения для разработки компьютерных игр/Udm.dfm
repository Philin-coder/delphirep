object dM: TdM
  ...
  object DSRZ: TDataSource
    DataSet = QueryRZ
    Left = 96
    Top = 352
  end
  object razdacha: TADOStoredProc
    Connection = ADOConnection1
    ProcedureName = 'razdacha;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object Queryfreeworkers: TADOQuery
    Connection = ADOConnection1
    Parameters = <>
    SQL.Strings = (
  ...
  object DSfreeworkers: TDataSource
    DataSet = Queryfreeworkers
    Left = 192
    Top = 336
  end
end
