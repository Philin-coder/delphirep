...
type
  TFrm_curr = class(TForm)
    ...
    curr_del_inp_Box: TGroupBox;
    curr_del_btn_Box: TGroupBox;
    curr_del_data_Box: TGroupBox;
    curr_del_btn: TButton;
    del_cur_DBL: TDBLookupComboBox;
    del_cur_lBL: TStaticText;
    ins_curr_Grid: TDBGrid;
    curr_upd_Grid: TDBGrid;
    curr_Del_Grid: TDBGrid;
    ...
    procedure curr_upd_btnClick(Sender: TObject);
    procedure curr_del_btnClick(Sender: TObject);
  private
...
procedure TFrm_curr.curr_del_btnClick(Sender: TObject);
var
      ...
      begin
        if not dm.Connection.Connected then
          raise EDatabaseError.Create('Соединение с базой не установлено',4001);
           Parameters.ParamByName('@id_curriculum').Value :=
           dm.currQuery.FieldByName('id_curriculum').AsString;
           ExecProc;
           dm.currQuery.Close;
           dm.currQuery.Open;
...
procedure TFrm_curr.curr_upd_btnClick(Sender: TObject);
var
  AreFieldsEmpty: Boolean;
begin
  AreFieldsEmpty:=(
