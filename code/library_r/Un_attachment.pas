...
type
  Tfrm_attachment = class(TForm)
    ...
    att_ins_doc_lbl: TStaticText;
    ins_att_data_d_lbl: TStaticText;
    ins_att_reader_lbl: TStaticText;
    dlv_data_return_fact_lbl: TStaticText;
    ins_att_doc_DBL: TDBLookupComboBox;
    ins_att_reader_DBL: TDBLookupComboBox;
    ins_att_Date_d_inp: TDateTimePicker;
    Ins_att_data_return_Plan_lbl: TStaticText;
    ins_att_Date_return_plan_inp: TDateTimePicker;
    upd_dlvGrid: TDBGrid;
