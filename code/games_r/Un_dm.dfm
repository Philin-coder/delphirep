object DM: TDM
  ...
  object upd_task: TADOStoredProc
    Connection = Connection
    ProcedureName = 'upd_task;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object upd_task_back: TADOStoredProc
    Connection = Connection
    ProcedureName = 'upd_task_back;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object del_task: TADOStoredProc
    Connection = Connection
    ProcedureName = 'del_task;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
