...
type
  TFrm_act_in = class(TForm)
    ...
    act_in_del_inp_Box: TGroupBox;
    act_in_del_btn_Box: TGroupBox;
    act_in_del_data_Box: TGroupBox;
    act_in_del_inp_lbl: TStaticText;
    act_in_del_inp_dbl: TDBLookupComboBox;
    act_in_del_btn: TButton;
    ...
    procedure act_in_del_btnClick(Sender: TObject);
  private
...
procedure TFrm_act_in.act_in_del_btnClick(Sender: TObject);
var
  AreFieldsEmpty: Boolean;
begin
  AreFieldsEmpty:=(
  (act_in_del_inp_dbl.Text='')
  );
