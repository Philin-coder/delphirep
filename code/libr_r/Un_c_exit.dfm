object Frm_c_exit: TFrm_c_exit
  ...
  object exit_cPC: TPageControl
    ...
    object insTab: TTabSheet
      Caption = #1042#1074#1086#1076' '#1080#1085#1092#1086#1088#1084#1072#1094#1080#1080' '#1086' '#1087#1088#1080#1095#1080#1085#1077' '#1074#1099#1073#1099#1090#1080#1103
      ImageIndex = 1
      ...
      object exit_c_couse_inp_Box: TGroupBox
        ...
        object exit_c_caose_inp: TLabeledEdit
          ...
          EditLabel.Width = 94
          EditLabel.Height = 13
          EditLabel.Caption = #1055#1088#1080#1095#1080#1085#1099' '#1074#1099#1073#1099#1090#1080#1103
          TabOrder = 0
        end
      end
    end
    object updTab: TTabSheet
      Caption = #1048#1079#1084#1077#1085#1077#1085#1080#1077' '#1085#1080#1092#1086#1088#1084#1072#1094#1080#1080' '#1086'  '#1087#1088#1080#1095#1080#1085#1077' '#1074#1099#1073#1099#1090#1080#1103
      ImageIndex = 2
      object Upd_exit_c_data_Box: TGroupBox
        Left = 0
        Top = 137
        Width = 1037
        Height = 199
      ...
      object Upd_exit_c_inp_Box: TGroupBox
        Left = 0
        Top = 0
        Width = 1037
        Height = 137
        ...
        Caption = #1042#1074#1086#1076' '#1076#1072#1085#1085#1099#1093
        TabOrder = 1
        object upd_exit_c_inp: TLabeledEdit
          Left = 3
          Top = 96
          Width = 1018
          Height = 21
          EditLabel.Width = 124
          EditLabel.Height = 13
          EditLabel.Caption = #1042#1074#1086#1076'  '#1087#1088#1080#1095#1080#1085#1099' '#1074#1099#1073#1099#1090#1080#1103
          TabOrder = 0
        end
        object upd_exit_c_id_dbl: TDBLookupComboBox
          Left = 3
          Top = 48
          Width = 1018
          Height = 21
        ...
        object upd_exit_c_id_lbl: TStaticText
          Left = 3
          Top = 25
          Width = 132
          Height = 17
          Caption = #1042#1099#1073#1086#1088' '#1087#1088#1080#1095#1080#1085#1099' '#1074#1099#1073#1099#1090#1080#1103
          TabOrder = 2
        end
      end
      object Upd_exit_c_btn_Box: TGroupBox
        Left = 0
        Top = 336
        Width = 1037
        Height = 69
        ...
        object Upd_exit_c_btn: TButton
          ...
          TabOrder = 0
          OnClick = Upd_exit_c_btnClick
        end
      end
    end
    object delTab: TTabSheet
      Caption = #1059#1076#1072#1083#1077#1085#1080#1077' '#1080#1085#1092#1086#1088#1084#1072#1094#1080#1080' '#1086' '#1087#1088#1080#1095#1080#1085#1077' '#1074#1099#1073#1099#1090#1080#1103
      ImageIndex = 3
      object exit_c_del_inp_Box: TGroupBox
        Left = 0
        Top = 0
        Width = 1037
        Height = 105
        ...
        Caption = #1042#1074#1086#1076' '#1076#1072#1085#1085#1099#1093
        TabOrder = 0
        object exit_c_del_inp_lbl: TStaticText
          Left = 3
          Top = 25
          Width = 132
          Height = 17
        ...
        object exit_c_del_inp_dbl: TDBLookupComboBox
          Left = 3
          Top = 48
          Width = 1018
          Height = 21
      ...
      object exit_c_del_btn_Box: TGroupBox
        Left = 0
        Top = 344
        Width = 1037
        Height = 61
        ...
        object exit_c_del_btn: TButton
          ...
          TabOrder = 0
          OnClick = exit_c_del_btnClick
        end
      end
      object exit_c_del_data_Box: TGroupBox
        Left = 0
        Top = 105
        Width = 1037
        Height = 239
