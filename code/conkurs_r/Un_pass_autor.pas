...
begin
 ...
 LoadFormState(Self);
 pass_a_grid.Columns[0].Title.Caption:='Номер порядковый';
 pass_a_grid.Columns[1].Title.Caption:='ФИО';
 pass_a_grid.Columns[2].Visible:=false;
 pass_a_grid.Columns[3].Visible:=False;
 pass_a_fio_inp.ShowHint:=True;
 pass_a_pwd_inp.ShowHint:=True;
 pass_a_fio_inp.Hint:='Пример ввода:'+#10#13+'Иванов Иван Иванович';
 pass_a_pwd_inp.Hint:='Пример ввода:'+#10#13+'my_pas';
end;
...
try
     ...
     pass_a_grid.Columns[0].Title.Caption:='Номер порядковый';
     pass_a_grid.Columns[1].Title.Caption:='ФИО';
     pass_a_grid.Columns[2].Title.Caption:='Телефон';
     pass_a_grid.Columns[3].Title.Caption:='Пароль';
end;
