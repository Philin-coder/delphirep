...
type
  TFrm_vaklst = class(TForm)
    ...
    delreslPage: TTabSheet;
    del_resdataBox: TGroupBox;
    resLbl: TLabel;
    delvakdatadgComboBox: TDBLookupComboBox;
    dlankbtnBox: TGroupBox;
    dlresBtn: TButton;
    dlressataBox: TGroupBox;
    ...
    vakablistDBL: TDBLookupComboBox;
    resanklbl: TLabel;
    ...
    procedure dlresBtnClick(Sender: TObject);
  private
...
procedure TFrm_vaklst.dlresBtnClick(Sender: TObject);
begin
        dm.doQuery.Close;
...
begin
  ...
  sql.Clear;
   ...
   begin
     ...
     'and  vakanlist.nomvlist='+Dm.resQuery.FieldByName('nomvlist').AsString;
