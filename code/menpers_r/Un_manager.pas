...
begin
  ...
  searchGrid.Columns[0].Title.Caption:='Номер порядковый ';
  searchGrid.Columns[1].Title.Caption:='ФИО менеджера';
  searchGrid.Columns[2].Title.Caption:='Контактные данные менеджера';
  searchGrid.Columns[3].Title.Caption:='E-mail менеджера';
  searchGrid.Columns[4].Title.Caption:='Телефон менеджера';
  searchGrid.Columns[5].Title.Caption:='Логин менеджера';
end;
...
begin
  search_stat:=0;
  search_cond_edit.EditLabel.Caption:='Поиск менеджера';
  search_cond_edit.Hint:='Поиск менеджера по ФИО';
...
begin
  ...
  search_cond_edit.Hint:='Поиск клиента по фамилии';
  search_cond_edit.Clear;
  search_cond_edit.SetFocus;
end;
2:
begin
  ...
  search_cond_edit.Hint:='Поиск плана по описанию';
  search_cond_edit.Clear;
  search_cond_edit.SetFocus;
end;
3:
begin
   ...
   search_cond_edit.Hint:='Поиск услуги по описанию';
   search_cond_edit.Clear;
   search_cond_edit.SetFocus;
end;
4:
begin
   search_stat:=4;
   search_cond_edit.EditLabel.Caption:='Поиск пользователя';
   search_cond_edit.Clear;
   search_cond_edit.SetFocus;
end;
end;//case
...
QuotedStr(Concat(search_cond_edit.Text,#37));
  ...
  searchGrid.Columns[0].Title.Caption:='Номер порядковый ';
  searchGrid.Columns[1].Title.Caption:='Имя клиента';
  searchGrid.Columns[2].Title.Caption:='Отчество клиента';
  searchGrid.Columns[3].Title.Caption:='Фамилия клиента';
  searchGrid.Columns[4].Title.Caption:='Дата рождения клиента';
  searchGrid.Columns[5].Title.Caption:='Контактные данные клиента';
  searchGrid.Columns[6].Title.Caption:='Телефон клиента';
  searchGrid.Columns[7].Title.Caption:='Название плана';
  searchGrid.Columns[8].Title.Caption:='Описание услуги';
  searchGrid.Columns[9].Title.Caption:='e-mail клиента';
  end;
  2:
  begin
    try
  ...
  ShowMessage('Ошибка'+' '+E.Message);
   ...
   searchGrid.Columns[0].Title.Caption:='Номер порядковый ';
   searchGrid.Columns[1].Title.Caption:='Название плана;';
   searchGrid.Columns[2].Title.Caption:='Дата вступления в силу';
   searchGrid.Columns[3].Title.Caption:='Описание';
   searchGrid.Columns[4].Title.Caption:='Менеджер';
  end;
  3:
  begin
     try
  ...
  searchGrid.Columns[0].Title.Caption:='Номер порядковый ';
  searchGrid.Columns[1].Title.Caption:='Описание услуги ';
  searchGrid.Columns[2].Visible:=False;
  searchGrid.Columns[2].Title.Caption:='Дата оказания услуги ';
  searchGrid.Columns[3].Title.Caption:='Цена услуги ';
  end;
  4:
  begin
     try
  ...
  searchGrid.Columns[0].Title.Caption:='Номер порядковый ';
  searchGrid.Columns[1].Title.Caption:='Пароль ';
  searchGrid.Columns[2].Title.Caption:='Логин ';
  end;
  end;//case
end;
