...
begin
  ...
  rp_upd_Grd.Columns[0].Title.Caption:='Номер порядковый';
  rp_upd_Grd.Columns[1].Title.Caption:='Описание';
  rp_upd_Grd.Columns[2].Title.Caption:='Дата оказания';
  rp_upd_Grd.Columns[3].Title.Caption:='Цена';
end;
   ...
   try
    ...
    begin
      ...
      Open;
       ...
       rp_upd_Grd.Columns[0].Title.Caption:='Имя';
       rp_upd_Grd.Columns[1].Title.Caption:='Отчество';
       rp_upd_Grd.Columns[2].Title.Caption:='Фамилия';
       rp_upd_Grd.Columns[3].Title.Caption:='Описание услуги';
       rp_upd_Grd.Columns[4].Title.Caption:='Цена';
       rp_upd_Grd.Columns[5].Title.Caption:='Дата оказания';
       rp_upd_Grd.Columns[6].Title.Caption:='Название плана';
       rp_upd_Grd.Columns[7].Title.Caption:='Описание плана';
       rp_upd_Grd.Columns[8].Title.Caption:='Менеджер';
    end;
  except
    on E: EDatabaseError do
      ShowMessage('Ошибка: ' + E.Message);
