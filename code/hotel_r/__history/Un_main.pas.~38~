...
// Активация формы
procedure TFrm_main.dog_itemClick(Sender: TObject);
begin

  try
    UpdateFormProperties('Frm_dog', 'Форма работы с договорм',
      clBtnFace, 1024, 768);
    Frm_dog.ShowModal;
  except
    Frm_dog.Free;
...
procedure TFrm_main.pay_itemClick(Sender: TObject);
begin
  try
    UpdateFormProperties('Frm_pay', 'Форма работы с оплатой',
      clBtnFace, 1024, 768);
    Frm_pay.ShowModal;
  except
    Frm_pay.Free;
